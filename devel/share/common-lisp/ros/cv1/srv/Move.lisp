...
(cl:defclass <Move-request> (roslisp-msg-protocol:ros-message)
  ((data
    ...
    :initarg :data
    :type cv1-msg:Data
    :initform (cl:make-instance 'cv1-msg:Data))
   (positions
    :reader positions
    :initarg :positions
...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv1-srv:<Move-request> is deprecated: use cv1-srv:Move-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv1-srv:data-val is deprecated.  Use cv1-srv:data instead.")
  (data m))

(cl:ensure-generic-function 'positions-val :lambda-list '(m))
(cl:defmethod positions-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv1-srv:positions-val is deprecated.  Use cv1-srv:positions instead.")
  (positions m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Move-request>)))
  ...
  (cl:format cl:nil "cv1/Data data~%float64[] positions~%~%================================================================================~%MSG: cv1/Data~%string name~%float64 velocity~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Move-request)))
  "Returns full string definition for message of type 'Move-request"
  (cl:format cl:nil "cv1/Data data~%float64[] positions~%~%================================================================================~%MSG: cv1/Data~%string name~%float64 velocity~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv1-srv:<Move-response> is deprecated: use cv1-srv:Move-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Move-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv1-srv:success-val is deprecated.  Use cv1-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Move-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv1-srv:message-val is deprecated.  Use cv1-srv:message instead.")
  (message m))
