...
(cl:defmethod cl:initialize-instance :after ((m <Data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv1-msg:<Data> is deprecated: use cv1-msg:Data instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv1-msg:name-val is deprecated.  Use cv1-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv1-msg:velocity-val is deprecated.  Use cv1-msg:velocity instead.")
  (velocity m))
